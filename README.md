...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/sridentify-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12131&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/sridentify-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `sridentify` can be installed with:

```
conda install sridentify
```

It is possible to list all of the versions of `sridentify` available on your platform with:
